        ...
        <div class="h-screen w-screen bg-white flex">
                ...
                <template v-if="skinSelectedProps != ''">
                    ...
                    <div class="w-full h-full flex">
                        ...
                        <div class="w-full h-full bg-zinc-300 p-4">
                            <h1 class="text-gray-700 text-2xl font-bold mb-2">{{ skinSelectedProps.name }}</h1>
                            <p class="text-sm text-gray-500 mb-4">{{ skinSelectedProps.type }}</p>
                            <p class="text-gray-500 text-sm mb-4">Start by uploading your full skin image on the right, and then add override slots for each of the areas that you want your skin to apply to.</p>
                            ...
                            <template v-if="'imgsrc' in skinSelectedProps">
                                ...
                                <h2 class="text-lg text-gray-500 font-bold py-4">Overrides</h2>
                                <p class="text-gray-500 text-sm mb-4 font-inter">Once you have added override slots, select the slot you want to edit, and then in the image preview, drag to select parts of the image to apply to that override slot.
                        ...
                        <div class="w-full h-full bg-zinc-200 pr-12">
                            <h2 class="text-lg text-gray-500 p-4">
                                <span class="text-lg font-bold">Image Preview: </span>
                                <span class="text-gray-400">Upload your full Skin image, then you can start selecting the area to use as overrides.</span>
                                <span 
                                    class="tooltip tooltip-left inline-block ml-2 text-gray-800 cursor-pointer" 
                                    @click="openModal"
                                    data-tip="Upload an image in PNG format, it can be in any size, but ensure that it has true transparency for it to work. WARNING: Images are not saved! If you close the browser, you will need to reupload your image.">
                                    ?
                                </span>
                            </h2>
                            <div class="w-full h-auto max-h-[500px] px-6">
                                <cropper 
                                    ref="cropperElement"
                                    id="skinImage"
                                    :canvas="{fillcolor: '#ffffff00'}" 
                                    class="w-full max-w-[100%] h-[500px]" 
                            ...
                            <template v-if="currentSelectedOverrideProps.length > 0">
                                <p class="text-sm text-gray-500 p-4">Updating Override for <span class="font-bold">{{ currentSelectedOverrideProps }}</span></p>
                            </template>
                            <template v-else>
                                <p class="text-sm text-red-500 p-4">Select an override slot on the left to start editing</p>
                            </template>
                            <div class="flex">
                    ...
                    <div class="flex space-x-4 justify-end absolute bottom-4 right-4">
...
//listview for overrides, also used for JSON output
